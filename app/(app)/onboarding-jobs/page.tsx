            ...
            className={cn(
                ...
                job.last_session_id
                    ? (isDarkMode
                        ...
                        : "bg-white border-cyan-200/60 shadow-sm hover:border-cyan-400 hover:shadow-xl hover:shadow-cyan-500/5")
                    : (isDarkMode
                        ? "bg-blue-500/5 border-blue-500/20 hover:bg-blue-500/10 hover:border-blue-500/40 hover:shadow-[0_0_20px_rgba(168,85,247,0.2)]"
                        : "bg-white border-blue-200/60 shadow-sm hover:border-blue-400 hover:shadow-xl hover:shadow-blue-500/5")
            )}
        >
            ...
            <div className="flex items-start justify-between gap-4 relative z-10 mb-4">
                <div className={cn(
                    ...
                    job.last_session_id
                        ...
                        : (isDarkMode ? "bg-blue-500/10 border-blue-500/30 text-blue-400 group-hover:border-blue-500/50 group-hover:text-blue-300 group-hover:bg-blue-500/20" : "bg-blue-100 border-blue-200 text-blue-600 group-hover:bg-blue-500/10 group-hover:text-blue-500 group-hover:border-blue-500/30")
                )}>
            ...
            <button
                ...
                className={cn(
                    ...
                    job.last_session_id
                        ...
                        : (isDarkMode
                            ? "bg-blue-500/10 text-blue-300 border border-blue-500/30 hover:bg-blue-600 hover:text-white hover:border-blue-500 shadow-[0_0_15px_rgba(168,85,247,0.1)] hover:shadow-[0_0_20px_rgba(168,85,247,0.4)]"
                            : "bg-blue-100/50 text-blue-700 border border-blue-200 hover:bg-blue-600 hover:text-white hover:border-blue-600 shadow-sm")
                )}
            >
                {job.last_session_id ? (
                    <>
    ...
    return (
        <div className="flex flex-col relative w-full h-full">
            ...
            <main className="flex-1 max-w-5xl mx-auto w-full px-6 py-8 relative z-10">
                {/* Top: Create New Job Form */}
                <div className={cn(
                    "mb-10 p-6 md:p-8 rounded-[2rem] border relative overflow-hidden",
                    isDarkMode ? "bg-[#0f172a]/80 border-blue-500/20" : "bg-white border-blue-200 shadow-xl shadow-blue-500/5"
                )}>
                    ...
                    <div className="relative">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="w-10 h-10 rounded-xl bg-blue-600 dark:bg-blue-500/20 flex items-center justify-center text-white dark:text-blue-400 border border-blue-500/20">
                        ...
                        <div className="flex flex-col md:flex-row gap-4">
                            <div className="flex-1 space-y-1.5">
                                <label className={cn("text-[10px] font-black uppercase tracking-widest", isDarkMode ? "text-blue-400/80" : "text-blue-600")}>Company Name *</label>
                                <Input
                            ...
                            <div className="flex-1 space-y-1.5">
                                <label className={cn("text-[10px] font-black uppercase tracking-widest", isDarkMode ? "text-blue-400/80" : "text-blue-600")}>Role / Title *</label>
                                <Input
                                    value={form.role}
                            ...
                            <div className="flex-[1.5] flex items-end">
                                <Button
                                    ...
                                    className={cn(
                                        "w-full h-12 rounded-xl font-black text-[10px] md:text-xs uppercase tracking-widest transition-all duration-300",
                                        isDarkMode
                                            ? "bg-blue-600 hover:bg-blue-500 text-white shadow-[0_0_20px_rgba(168,85,247,0.3)] hover:shadow-[0_0_30px_rgba(168,85,247,0.5)] disabled:opacity-50 disabled:shadow-none border border-blue-500/50"
                                            : "bg-blue-600 hover:bg-blue-500 text-white shadow-lg shadow-blue-500/30 disabled:opacity-50"
                                    )}
                                >
                                    {submitting ? (
                                        <div className="flex items-center gap-2">
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        {jobs.filter(j => !j.last_session_id).length > 0 && (
                            <div className="mb-12">
                                ...
                                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                                    <AnimatePresence>
                                        {jobs.filter(j => !j.last_session_id).map((job, i) => renderJobCard(job, i))}
                                    </AnimatePresence>
                                </div>
                            </div>
                        )}

                        {/* Section 2: Ready For Sync */}
                        {jobs.filter(j => j.last_session_id).length > 0 && (
                            <div className="mb-8">
                                <div className="flex items-center gap-2 mb-6">
                        ...
                        {jobs.length === 0 && !loading && (
                            <div className="text-center py-20 opacity-50">
                                ...
                                <p className="text-sm font-bold uppercase tracking-widest">No contexts created yet.</p>
                            </div>
                        )}
                    </>
                )}
                        ...
                        >
                            <motion.div
                                ...
                                className={cn(
                                    ...
                                    isDarkMode ? "bg-[#0f172a] border-blue-500/20" : "bg-white border-blue-200 shadow-2xl"
                                )}
                            >
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        isDarkMode ? "text-blue-400/60 hover:text-blue-200 hover:bg-blue-500/10" : "text-blue-400 hover:text-blue-900 hover:bg-blue-50"
                                    )}
                                >
                                    <X className="w-5 h-5" />
                                </button>
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-1.5">
                                        <label className={cn("text-[10px] font-black uppercase tracking-widest", isDarkMode ? "text-blue-400/80" : "text-blue-600")}>
                                            Company Name *
                                        </label>
                                        <Input
                                            value={form.company_name}
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="mb-6 flex-shrink-0 flex items-center justify-between pr-10">
                                    <div>
                                        <h2 className={cn("text-2xl font-black uppercase tracking-tight", isDarkMode ? "text-blue-50" : "text-blue-950")}>Session Transcripts</h2>
                                        <p className={cn("text-[10px] font-bold uppercase tracking-widest mt-1", isDarkMode ? "text-blue-400/60" : "text-blue-500")}>
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            isDarkMode
                                                ? "bg-white/5 border-white/10 text-blue-400 hover:bg-white/10 hover:border-white/20"
                                ...
                                <div className="flex-1 overflow-y-auto pr-2 min-h-[200px]">
                                    {loadingSessions ? (
                                        ...
                                        <div className="flex flex-col items-center justify-center h-full space-y-4 opacity-50 py-10">
                                            <div className="relative">
                                                <div className={cn("absolute inset-0 blur-xl rounded-full opacity-20", isDarkMode ? "bg-blue-500" : "bg-blue-200")} />
                                                <FileText className={cn("w-16 h-16 relative z-10", isDarkMode ? "text-blue-500/40" : "text-blue-300")} />
                                            </div>
                                            <div className="text-center space-y-1">
                                                <p className={cn("text-xs font-black uppercase tracking-widest", isDarkMode ? "text-blue-300" : "text-blue-700")}>No Sessions Found</p>
                                                ...
                                                <div
                                                    ...
                                                    className={cn(
                                                        ...
                                                        isDarkMode
                                                            ...
                                                            : "bg-blue-50/50 border-blue-100 hover:bg-blue-100/80 hover:border-blue-300"
                                                    )}
                                                >
                                                    <div className="flex flex-col truncate pr-4">
                                                        <span className={cn("font-bold text-sm truncate transition-colors", isDarkMode ? "text-slate-200 group-hover:text-white" : "text-slate-800 group-hover:text-blue-900")}>
                                                            {session.meeting_title || "Neural Sync Session"}
                                                        </span>
                                                        <span className={cn("text-[10px] uppercase font-bold tracking-widest mt-1", isDarkMode ? "text-blue-400/70" : "text-blue-500")}>
                                                            {new Date(session.created_at).toLocaleDateString()}
                                                        </span>
                                                    </div>
                                                    <div className={cn("p-2 rounded-lg flex-shrink-0 transition-colors", isDarkMode ? "bg-slate-800/80 text-blue-400 group-hover:bg-blue-500/20 group-hover:text-blue-300" : "bg-white text-blue-400 group-hover:bg-blue-100 group-hover:text-blue-600 shadow-sm")}>
