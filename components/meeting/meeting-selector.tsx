...
export function MeetingSelector({ type, onSelect }: MeetingSelectorProps) {
    ...
    return (
        <div className="w-full max-w-5xl mx-auto space-y-12 py-10 px-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            {/* Header Section: Neural Archives */}
            <div className="space-y-6 relative">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-slate-200 dark:border-white/5">
                    ...
                    {type === "scrum" ? (
                        <div className="p-4 bg-violet-500/10 rounded-2xl border border-violet-500/20 text-violet-500 shadow-xl shadow-violet-500/5">
                            <Ticket className="w-8 h-8" />
                        </div>
                    ) : (
                        <div className="p-4 bg-blue-500/10 rounded-2xl border border-blue-500/20 text-blue-500 shadow-xl shadow-blue-500/5">
                        ...
                        >
                            <div className="flex items-center justify-between p-5 bg-white dark:bg-white/[0.02] hover:bg-slate-50 dark:hover:bg-white/[0.05] border border-slate-200 dark:border-white/5 rounded-2xl transition-all duration-300 shadow-sm hover:shadow-md hover:border-blue-500/30 dark:hover:border-cyan-500/30 relative overflow-hidden">
                                ...
                                <div className="flex items-center gap-5 flex-1 min-w-0">
                                    <div className={cn(
                                        "w-12 h-12 rounded-xl flex items-center justify-center transition-all shadow-sm border shrink-0",
                                        type === "scrum" 
                                    ...
                                    <div className="space-y-1.5 flex-1 min-w-0">
                                        <div className="flex items-center gap-2">
                                            <h3 className="text-lg font-black text-slate-800 dark:text-white tracking-tight truncate leading-tight group-hover:text-blue-600 dark:group-hover:text-cyan-400 transition-colors">
                                        ...
                                        <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
                                            <div className="flex items-center gap-1.5 text-slate-500">
                                                ...
                                                <span className="text-[10px] font-bold uppercase tracking-widest whitespace-nowrap">
                                                    {meeting.start_time ? format(new Date(meeting.start_time), "MMM d, yyyy") : "Archive Date Missing"}
                                ...
                                <div className="flex items-center gap-6 shrink-0">
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            "flex items-center gap-2 px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-[2px] transition-all active:scale-95 border",
                                            type === "scrum"
